...
export default function Features() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 border-b-4 border-t-4 border-border ">
      <section className="border-b-4 md:border-r-4 border-border md:bg-background bg-main text-white md:text-foreground 2xl:p-14 2xl:py-16 xl:p-10 xl:py-10 lg:p-8 lg:py-10 p-5 py-7">
        <div className="flex items-center gap-4 sm:gap-6 mb-4 sm:mb-6">
          <div className="size-10 sm:size-12 lg:size-[55px] xl:size-[70px] flex items-center justify-center">
            <ShieldCheck className="w-full h-full" />
          </div>
          <h3 className="text-center font-heading not-prose 2xl:text-5xl xl:text-5xl md:text-4xl sm:text-3xl text-[22px] ">Blockchain Secured</h3>
        </div>
      ...
      <section className="border-b-4 border-border md:bg-main bg-background text-main-foreground md:text-white md:dark:text-main-foreground dark:text-foreground 2xl:p-14 2xl:py-16 xl:p-10 xl:py-10 lg:p-8 lg:py-10 p-5 py-7">
        <div className="flex items-center gap-4 sm:gap-6 mb-4 sm:mb-6">
          <div className="size-10 sm:size-12 lg:size-[55px] xl:size-[70px] flex items-center justify-center">
            <UserPlus className="w-full h-full " />
          </div>
          <h3 className="text-center font-heading not-prose 2xl:text-5xl xl:text-5xl md:text-4xl sm:text-3xl text-[22px]">Connect with Web3</h3>
        </div>
        <p className="2xl:text-2xl xl:text-xl md:text-base sm:text-lg text-base ">
      ...
      <section className="md:border-r-4 border-b-4 border-border bg-main text-white dark:text-main-foreground 2xl:p-14 2xl:py-16 xl:p-10 xl:py-10 lg:p-8 lg:py-10 p-5 py-7">
        <div className="flex items-center gap-4 sm:gap-6 mb-4 sm:mb-6">
          <div className="size-10 sm:size-12 lg:size-[55px] xl:size-[70px] flex items-center justify-center">
            <Link2 className="w-full h-full " />
          </div>
          <h3 className="text-center font-heading not-prose 2xl:text-5xl xl:text-5xl md:text-4xl sm:text-3xl text-[22px] ">Share with Anyone</h3>
        </div>
        <p className="2xl:text-2xl xl:text-xl md:text-base sm:text-lg text-base ">
